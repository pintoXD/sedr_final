...
HD_PWD='C:/Users/calan/Google Drive/SEDR/integration_desesperado/integration_desesperado.runs/design_1_buf_in_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_buf_in_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_buf_in_0_0.tcl
