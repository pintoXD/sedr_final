...
module design_1
  ...
  assign clk_1 = clk;
  assign con_out_666[3] = buf_in_0_dv_out;
  assign con_out_666[2] = buf_in_0_dv_out;
  assign con_out_666[1] = buf_in_0_dv_out;
  assign con_out_666[0] = buf_in_0_dv_out;
  assign count_buffer_saida[3:0] = buffer_64_to_8_0_counter_out;
  assign data_in_1 = data_in[7:0];
  assign data_out_666[63:0] = PRESENT_ENCRYPT_0_odat;
