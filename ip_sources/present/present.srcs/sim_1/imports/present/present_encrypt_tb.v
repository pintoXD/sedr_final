...
module PRESENT_ENCRYPT_TB;
   ...
   initial
   begin
      #15   load = 1'b1; idat = `PLAINTEXT0; key = `KEY0;
      #10   load = 1'b0;
      #400  load = 1'b1; idat = `PLAINTEXT1; key = `KEY0;
      #10   load = 1'b0;
      #320  load = 1'b1; idat = `PLAINTEXT2; key = `KEY0;
      #10   load = 1'b0;
      #320  load = 1'b1; idat = `PLAINTEXT3; key = `KEY0;
      #10   load = 1'b0;
      #320  load = 1'b1; idat = `PLAINTEXT4; key = `KEY0;
      #10   load = 1'b0;
